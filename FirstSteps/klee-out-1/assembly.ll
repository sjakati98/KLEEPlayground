...
@.str7 = private unnamed_addr constant [40 x i8] c"Wrong command!(only w,s,a,d accepted!)\0A\00", align 1
@.str8 = private unnamed_addr constant [12 x i8] c"You loose!\0A\00", align 1
@.str9 = private unnamed_addr constant [10 x i8] c"You win!\0A\00", align 1
@.str10 = private unnamed_addr constant [22 x i8] c"Your solution <%42s>\0A\00", align 1
@.str11 = private unnamed_addr constant [34 x i8] c"Iteration no. %d. Action: %c. %s\0A\00", align 1
@.str12 = private unnamed_addr constant [9 x i8] c"Blocked!\00", align 1
@.str13 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@.str14 = private unnamed_addr constant [11 x i8] c"You loose\0A\00", align 1
@.str15 = private unnamed_addr constant [12 x i8] c"klee_choose\00", align 1
@.str116 = private unnamed_addr constant [60 x i8] c"/home/klee/klee_src/runtime/Intrinsic/klee_div_zero_check.c\00", align 1
@.str1217 = private unnamed_addr constant [15 x i8] c"divide by zero\00", align 1
...
@.str621 = private unnamed_addr constant [51 x i8] c"/home/klee/klee_src/runtime/Intrinsic/klee_range.c\00", align 1
...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  %19 = call i32 (i32, i8*, i32, ...)* bitcast (i32 (...)* @read to i32 (i32, i8*, i32, ...)*)(i32 0, i8* %18, i32 28), !dbg !160
  br label %20, !dbg !161

; <label>:20                                      ; preds = %120, %0
  %21 = load i32* %i, align 4, !dbg !161
  %22 = icmp slt i32 %21, 28, !dbg !161
  br i1 %22, label %23, label %130, !dbg !161

; <label>:23                                      ; preds = %20
  %24 = load i32* %x, align 4, !dbg !162
  store i32 %24, i32* %ox, align 4, !dbg !162
  %25 = load i32* %y, align 4, !dbg !164
  store i32 %25, i32* %oy, align 4, !dbg !164
  %26 = load i32* %i, align 4, !dbg !165
  %27 = sext i32 %26 to i64, !dbg !165
  %28 = getelementptr inbounds [28 x i8]* %program, i32 0, i64 %27, !dbg !165
  %29 = load i8* %28, align 1, !dbg !165
  %30 = sext i8 %29 to i32, !dbg !165
...
; <label>:31                                      ; preds = %23
  %32 = load i32* %y, align 4, !dbg !166
  %33 = add nsw i32 %32, -1, !dbg !166
  store i32 %33, i32* %y, align 4, !dbg !166
  br label %46, !dbg !168

; <label>:34                                      ; preds = %23
  %35 = load i32* %y, align 4, !dbg !169
  %36 = add nsw i32 %35, 1, !dbg !169
  store i32 %36, i32* %y, align 4, !dbg !169
  br label %46, !dbg !170

; <label>:37                                      ; preds = %23
  %38 = load i32* %x, align 4, !dbg !171
  %39 = add nsw i32 %38, -1, !dbg !171
  store i32 %39, i32* %x, align 4, !dbg !171
  br label %46, !dbg !172

; <label>:40                                      ; preds = %23
  %41 = load i32* %x, align 4, !dbg !173
  %42 = add nsw i32 %41, 1, !dbg !173
  store i32 %42, i32* %x, align 4, !dbg !173
  br label %46, !dbg !174

; <label>:43                                      ; preds = %23
  %44 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([40 x i8]* @.str7, i32 0, i32 0)), !dbg !175
  %45 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str8, i32 0, i32 0)), !dbg !176
  call void @exit(i32 -1) #7, !dbg !177
  unreachable, !dbg !177

; <label>:46                                      ; preds = %40, %37, %34, %31
  %47 = load i32* %x, align 4, !dbg !178
  %48 = sext i32 %47 to i64, !dbg !178
  %49 = load i32* %y, align 4, !dbg !178
  %50 = sext i32 %49 to i64, !dbg !178
  %51 = getelementptr inbounds [7 x [11 x i8]]* @maze, i32 0, i64 %50, !dbg !178
  %52 = getelementptr inbounds [11 x i8]* %51, i32 0, i64 %48, !dbg !178
  %53 = load i8* %52, align 1, !dbg !178
  %54 = sext i8 %53 to i32, !dbg !178
  %55 = icmp eq i32 %54, 35, !dbg !178
  br i1 %55, label %56, label %60, !dbg !178

; <label>:56                                      ; preds = %46
  %57 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str9, i32 0, i32 0)), !dbg !180
  %58 = getelementptr inbounds [28 x i8]* %program, i32 0, i32 0, !dbg !182
  %59 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str10, i32 0, i32 0), i8* %58), !dbg !182
  call void @exit(i32 1) #7, !dbg !183
  unreachable, !dbg !183

; <label>:60                                      ; preds = %46
  %61 = load i32* %x, align 4, !dbg !184
  %62 = sext i32 %61 to i64, !dbg !184
  %63 = load i32* %y, align 4, !dbg !184
  %64 = sext i32 %63 to i64, !dbg !184
  %65 = getelementptr inbounds [7 x [11 x i8]]* @maze, i32 0, i64 %64, !dbg !184
  %66 = getelementptr inbounds [11 x i8]* %65, i32 0, i64 %62, !dbg !184
  %67 = load i8* %66, align 1, !dbg !184
  %68 = sext i8 %67 to i32, !dbg !184
  %69 = icmp ne i32 %68, 32, !dbg !184
  br i1 %69, label %70, label %90, !dbg !184

; <label>:70                                      ; preds = %60
  %71 = load i32* %y, align 4, !dbg !184
  %72 = icmp eq i32 %71, 2, !dbg !184
  br i1 %72, label %73, label %87, !dbg !184

; <label>:73                                      ; preds = %70
  %74 = load i32* %x, align 4, !dbg !184
  %75 = sext i32 %74 to i64, !dbg !184
  %76 = load i32* %y, align 4, !dbg !184
  %77 = sext i32 %76 to i64, !dbg !184
  %78 = getelementptr inbounds [7 x [11 x i8]]* @maze, i32 0, i64 %77, !dbg !184
  %79 = getelementptr inbounds [11 x i8]* %78, i32 0, i64 %75, !dbg !184
  %80 = load i8* %79, align 1, !dbg !184
  %81 = sext i8 %80 to i32, !dbg !184
  %82 = icmp eq i32 %81, 124, !dbg !184
  %83 = load i32* %x, align 4, !dbg !184
  %84 = icmp sgt i32 %83, 0, !dbg !184
  %or.cond = and i1 %82, %84, !dbg !184
  %85 = load i32* %x, align 4, !dbg !184
  %86 = icmp slt i32 %85, 11, !dbg !184
  %or.cond3 = and i1 %or.cond, %86, !dbg !184
  br i1 %or.cond3, label %90, label %87, !dbg !184

; <label>:87                                      ; preds = %73, %70
  %88 = load i32* %ox, align 4, !dbg !186
  store i32 %88, i32* %x, align 4, !dbg !186
  %89 = load i32* %oy, align 4, !dbg !188
  store i32 %89, i32* %y, align 4, !dbg !188
  br label %90, !dbg !189

; <label>:90                                      ; preds = %73, %87, %60
  %91 = load i32* %x, align 4, !dbg !190
  %92 = load i32* %y, align 4, !dbg !190
  %93 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([19 x i8]* @.str3, i32 0, i32 0), i32 %91, i32 %92), !dbg !190
  %94 = load i32* %i, align 4, !dbg !191
  %95 = load i32* %i, align 4, !dbg !191
  %96 = sext i32 %95 to i64, !dbg !191
  %97 = getelementptr inbounds [28 x i8]* %program, i32 0, i64 %96, !dbg !191
  %98 = load i8* %97, align 1, !dbg !191
  %99 = sext i8 %98 to i32, !dbg !191
  %100 = load i32* %ox, align 4, !dbg !191
  %101 = load i32* %x, align 4, !dbg !191
  %102 = icmp eq i32 %100, %101, !dbg !191
  br i1 %102, label %103, label %107, !dbg !191

; <label>:103                                     ; preds = %90
  %104 = load i32* %oy, align 4, !dbg !191
  %105 = load i32* %y, align 4, !dbg !191
  %106 = icmp eq i32 %104, %105, !dbg !191
  br label %107

; <label>:107                                     ; preds = %103, %90
  %108 = phi i1 [ false, %90 ], [ %106, %103 ]
  %109 = select i1 %108, i8* getelementptr inbounds ([9 x i8]* @.str12, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str13, i32 0, i32 0)
  %110 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([34 x i8]* @.str11, i32 0, i32 0), i32 %94, i32 %99, i8* %109), !dbg !191
  %111 = load i32* %ox, align 4, !dbg !192
  %112 = load i32* %x, align 4, !dbg !192
  %113 = icmp eq i32 %111, %112, !dbg !192
  br i1 %113, label %114, label %120, !dbg !192

; <label>:114                                     ; preds = %107
  %115 = load i32* %oy, align 4, !dbg !192
  %116 = load i32* %y, align 4, !dbg !192
  %117 = icmp eq i32 %115, %116, !dbg !192
  br i1 %117, label %118, label %120, !dbg !192

; <label>:118                                     ; preds = %114
  %119 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str14, i32 0, i32 0)), !dbg !194
  call void @exit(i32 -2) #7, !dbg !196
  unreachable, !dbg !196

; <label>:120                                     ; preds = %114, %107
  %121 = load i32* %x, align 4, !dbg !197
  %122 = sext i32 %121 to i64, !dbg !197
  %123 = load i32* %y, align 4, !dbg !197
  %124 = sext i32 %123 to i64, !dbg !197
  %125 = getelementptr inbounds [7 x [11 x i8]]* @maze, i32 0, i64 %124, !dbg !197
  %126 = getelementptr inbounds [11 x i8]* %125, i32 0, i64 %122, !dbg !197
  store i8 88, i8* %126, align 1, !dbg !197
  call void @draw(), !dbg !198
  %127 = load i32* %i, align 4, !dbg !199
  %128 = add nsw i32 %127, 1, !dbg !199
  store i32 %128, i32* %i, align 4, !dbg !199
  %129 = call i32 (i32, ...)* bitcast (i32 (...)* @sleep to i32 (i32, ...)*)(i32 1), !dbg !200
  br label %20, !dbg !201

; <label>:130                                     ; preds = %20
  %131 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str14, i32 0, i32 0)), !dbg !202
  %132 = load i32* %1, !dbg !203
  ret i32 %132, !dbg !203
}
...
define i64 @klee_choose(i64 %n) #4 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 8, i8* getelementptr inbounds ([12 x i8]* @.str15, i64 0, i64 0)) #8, !dbg !204
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([60 x i8]* @.str116, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str1217, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str218, i64 0, i64 0)) #9, !dbg !215
  unreachable, !dbg !215
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str319, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str1420, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #9, !dbg !223
  unreachable, !dbg !223
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([51 x i8]* @.str621, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #9, !dbg !228
  unreachable, !dbg !228
...
!160 = metadata !{i32 72, i32 0, metadata !8, null}
