...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call i32 (i32*, i64, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i64, i8*, ...)*)(i32* %a, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0)), !dbg !134
  %3 = load i32* %a, align 4, !dbg !135
  %4 = call i32 @get_sign(i32 %3), !dbg !135
  ret i32 %4, !dbg !135
}
...
define i32 @get_sign(i32 %x) #0 {
  ...
  %3 = load i32* %2, align 4, !dbg !136
  %4 = icmp eq i32 %3, 0, !dbg !136
...
; <label>:6                                       ; preds = %0
  %7 = load i32* %2, align 4, !dbg !139
  %8 = icmp slt i32 %7, 0, !dbg !139
  br i1 %8, label %9, label %10, !dbg !139

; <label>:9                                       ; preds = %6
  store i32 -1, i32* %1, !dbg !141
  br label %11, !dbg !141

; <label>:10                                      ; preds = %6
  store i32 1, i32* %1, !dbg !142
  br label %11, !dbg !142

; <label>:11                                      ; preds = %10, %9, %5
  %12 = load i32* %1, !dbg !143
  ret i32 %12, !dbg !143
}
...
define i64 @klee_choose(i64 %n) #3 {
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %1, i64 8, i8* getelementptr inbounds ([12 x i8]* @.str1, i64 0, i64 0)) #6, !dbg !144
...
define i32 @klee_int(i8* %name) #3 {
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %1, i64 4, i8* %name) #6, !dbg !157
...
; <label>:6                                       ; preds = %3
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %7, i64 4, i8* %name) #6, !dbg !171
...
!1 = metadata !{metadata !"tutorial_one.c", metadata !"/home/klee/KLEEPlayground"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/klee/KLEEPlayground/tutorial_one.c]
!6 = metadata !{i32 786453, i32 0, null, metadata !"", i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !7, i32 0, null, null, null} ; [ DW_TAG_subroutine_type ] [line 0, size 0, align 0, offset 0] [from ]
!7 = metadata !{metadata !8}
!8 = metadata !{i32 786468, null, null, metadata !"int", i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ] [int] [line 0, size 32, align 32, offset 0, enc DW_ATE_signed]
!9 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"get_sign", metadata !"get_sign", metadata !"", i32 11, metadata !10, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32)* @get_sign, null, null, metadata !2, i32 11} ; [ DW_
...
!136 = metadata !{i32 12, i32 0, metadata !137, null}
!137 = metadata !{i32 786443, metadata !1, metadata !9, i32 12, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/KLEEPlayground/tutorial_one.c]
!138 = metadata !{i32 13, i32 0, metadata !137, null}
!139 = metadata !{i32 14, i32 0, metadata !140, null}
!140 = metadata !{i32 786443, metadata !1, metadata !137, i32 14, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/KLEEPlayground/tutorial_one.c]
!141 = metadata !{i32 15, i32 0, metadata !140, null}
!142 = metadata !{i32 17, i32 0, metadata !140, null}
!143 = metadata !{i32 18, i32 0, metadata !9, null}
