...
define i32 @main() #0 {
  ...
  %6 = getelementptr inbounds [4 x i8]* %input, i32 0, i32 0, !dbg !145
  %7 = call i32 @primary_function_2(i8* %6), !dbg !145
  ret i32 0, !dbg !146
}
...
define i32 @primary_function_2(i8* %input) #0 {
  ...
  %2 = load i8** %1, align 8, !dbg !147
  %3 = call i32 @atoi(i8* %2) #9, !dbg !147
  store i32 %3, i32* %result, align 4, !dbg !147
  %4 = load i32* %result, align 4, !dbg !148
  %5 = icmp eq i32 %4, 42, !dbg !148
  br i1 %5, label %6, label %8, !dbg !148
...
; <label>:8                                       ; preds = %6, %0
  %9 = load i32* %result, align 4, !dbg !151
  ret i32 %9, !dbg !151
}
...
define i32 @external_function(i32* %values, i32 %l, i32 %r, i32 %elem) #0 {
  ...
  %7 = load i32* %4, align 4, !dbg !152
  %8 = icmp sgt i32 %6, %7, !dbg !152
  br i1 %8, label %9, label %10, !dbg !152

; <label>:9                                       ; preds = %0
  store i32 -1, i32* %1, !dbg !154
  br label %48, !dbg !154

; <label>:10                                      ; preds = %0
  %11 = load i32* %3, align 4, !dbg !155
  %12 = load i32* %3, align 4, !dbg !155
  %13 = load i32* %4, align 4, !dbg !155
  %14 = sub nsw i32 %12, %13, !dbg !155
  %int_cast_to_i64 = zext i32 2 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i64), !dbg !155
  %15 = sdiv i32 %14, 2, !dbg !155
  %16 = add nsw i32 %11, %15, !dbg !155
  store i32 %16, i32* %mid, align 4, !dbg !155
  %17 = load i32* %5, align 4, !dbg !157
  %18 = load i32* %mid, align 4, !dbg !157
  %19 = sext i32 %18 to i64, !dbg !157
  %20 = load i32** %2, align 8, !dbg !157
  %21 = getelementptr inbounds i32* %20, i64 %19, !dbg !157
  %22 = load i32* %21, align 4, !dbg !157
  %23 = icmp slt i32 %17, %22, !dbg !157
  br i1 %23, label %24, label %31, !dbg !157

; <label>:24                                      ; preds = %10
  %25 = load i32** %2, align 8, !dbg !159
  %26 = load i32* %3, align 4, !dbg !159
  %27 = load i32* %mid, align 4, !dbg !159
  %28 = sub nsw i32 %27, 1, !dbg !159
  %29 = load i32* %5, align 4, !dbg !159
  %30 = call i32 @external_function(i32* %25, i32 %26, i32 %28, i32 %29), !dbg !159
  store i32 %30, i32* %1, !dbg !159
  br label %48, !dbg !159

; <label>:31                                      ; preds = %10
  %32 = load i32* %5, align 4, !dbg !160
  %33 = load i32* %mid, align 4, !dbg !160
  %34 = sext i32 %33 to i64, !dbg !160
  %35 = load i32** %2, align 8, !dbg !160
  %36 = getelementptr inbounds i32* %35, i64 %34, !dbg !160
  %37 = load i32* %36, align 4, !dbg !160
  %38 = icmp sgt i32 %32, %37, !dbg !160
  br i1 %38, label %39, label %46, !dbg !160

; <label>:39                                      ; preds = %31
  %40 = load i32** %2, align 8, !dbg !162
  %41 = load i32* %mid, align 4, !dbg !162
  %42 = add nsw i32 %41, 1, !dbg !162
  %43 = load i32* %4, align 4, !dbg !162
  %44 = load i32* %5, align 4, !dbg !162
  %45 = call i32 @external_function(i32* %40, i32 %42, i32 %43, i32 %44), !dbg !162
  store i32 %45, i32* %1, !dbg !162
  br label %48, !dbg !162

; <label>:46                                      ; preds = %31
  %47 = load i32* %mid, align 4, !dbg !163
  store i32 %47, i32* %1, !dbg !163
  br label %48, !dbg !163

; <label>:48                                      ; preds = %46, %39, %24, %9
  %49 = load i32* %1, !dbg !164
  ret i32 %49, !dbg !164
}
...
define i32 @primary_function_1(i32* %values, i32 %elem) #0 {
  ...
  %4 = load i32** %2, align 8, !dbg !165
  %5 = load i32* %3, align 4, !dbg !165
  %6 = call i32 @external_function(i32* %4, i32 0, i32 8, i32 %5), !dbg !165
  store i32 %6, i32* %search_result, align 4, !dbg !165
  %7 = load i32* %search_result, align 4, !dbg !166
  %8 = icmp eq i32 %7, 0, !dbg !166
  br i1 %8, label %9, label %11, !dbg !166
...
; <label>:9                                       ; preds = %0
  ...
  store i32 0, i32* %1, !dbg !170
  br label %13, !dbg !170

; <label>:11                                      ; preds = %0
  %12 = load i32* %search_result, align 4, !dbg !171
...
define i64 @klee_choose(i64 %n) #6 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 8, i8* getelementptr inbounds ([12 x i8]* @.str4, i64 0, i64 0)) #10, !dbg !173
  %2 = load i64* %x, align 8, !dbg !174, !tbaa !176
  %3 = icmp ult i64 %2, %n, !dbg !174
  br i1 %3, label %5, label %4, !dbg !174

; <label>:4                                       ; preds = %0
  call void @klee_silent_exit(i32 0) #11, !dbg !180
  unreachable, !dbg !180
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([60 x i8]* @.str15, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str26, i64 0, i64 0)) #11, !dbg !184
  unreachable, !dbg !184
...
define i32 @klee_int(i8* %name) #6 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #10, !dbg !186
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str37, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #11, !dbg !192
  unreachable, !dbg !192
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([51 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #11, !dbg !197
  unreachable, !dbg !197
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #10, !dbg !200
...
!145 = metadata !{i32 18, i32 0, metadata !4, null}
!146 = metadata !{i32 20, i32 0, metadata !4, null}
!147 = metadata !{i32 56, i32 0, metadata !16, null}
!148 = metadata !{i32 57, i32 0, metadata !149, null}
!149 = metadata !{i32 786443, metadata !1, metadata !16, i32 57, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/klee/KLEEPlayground/ChallengeProblem/external_function.c]
!150 = metadata !{i32 58, i32 0, metadata !149, null} ; [ DW_TAG_imported_module ]
!151 = metadata !{i32 59, i32 0, metadata !16, null}
!152 = metadata !{i32 24, i32 0, metadata !153, null}
!153 = metadata !{i32 786443, metadata !1, metadata !9, i32 24, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/KLEEPlayground/ChallengeProblem/external_function.c]
!154 = metadata !{i32 25, i32 0, metadata !153, null}
!155 = metadata !{i32 27, i32 0, metadata !156, null}
!156 = metadata !{i32 786443, metadata !1, metadata !153, i32 26, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/KLEEPlayground/ChallengeProblem/external_function.c]
!157 = metadata !{i32 28, i32 0, metadata !158, null}
!158 = metadata !{i32 786443, metadata !1, metadata !156, i32 28, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/klee/KLEEPlayground/ChallengeProblem/external_function.c]
!159 = metadata !{i32 29, i32 0, metadata !158, null}
!160 = metadata !{i32 30, i32 0, metadata !161, null}
!161 = metadata !{i32 786443, metadata !1, metadata !158, i32 30, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/KLEEPlayground/ChallengeProblem/external_function.c]
!162 = metadata !{i32 31, i32 0, metadata !161, null}
!163 = metadata !{i32 33, i32 0, metadata !161, null}
!164 = metadata !{i32 36, i32 0, metadata !9, null}
!165 = metadata !{i32 39, i32 0, metadata !13, null}
!166 = metadata !{i32 40, i32 0, metadata !167, null}
!167 = metadata !{i32 786443, metadata !1, metadata !13, i32 40, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/klee/KLEEPlayground/ChallengeProblem/external_function.c]
!168 = metadata !{i32 41, i32 0, metadata !169, null}
!169 = metadata !{i32 786443, metadata !1, metadata !167, i32 40, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/klee/KLEEPlayground/ChallengeProblem/external_function.c]
!170 = metadata !{i32 42, i32 0, metadata !169, null}
!171 = metadata !{i32 45, i32 0, metadata !167, null}
!172 = metadata !{i32 46, i32 0, metadata !13, null}
!173 = metadata !{i32 14, i32 0, metadata !24, null}
!174 = metadata !{i32 17, i32 0, metadata !175, null}
!175 = metadata !{i32 786443, metadata !22, metadata !24, i32 17, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_choose.c]
...
!181 = metadata !{i32 19, i32 0, metadata !24, null}
!182 = metadata !{i32 13, i32 0, metadata !183, null}
!183 = metadata !{i32 786443, metadata !34, metadata !36, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_div_zero_check.c]
!184 = metadata !{i32 14, i32 0, metadata !183, null}
!185 = metadata !{i32 15, i32 0, metadata !36, null}
!186 = metadata !{i32 15, i32 0, metadata !46, null}
!187 = metadata !{i32 16, i32 0, metadata !46, null}
...
!191 = metadata !{i32 786443, metadata !56, metadata !58, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_overshift_check.c]
!192 = metadata !{i32 27, i32 0, metadata !193, null}
!193 = metadata !{i32 786443, metadata !56, metadata !191, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_overshift_check.c]
!194 = metadata !{i32 29, i32 0, metadata !58, null}
!195 = metadata !{i32 16, i32 0, metadata !196, null}
!196 = metadata !{i32 786443, metadata !67, metadata !69, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!197 = metadata !{i32 17, i32 0, metadata !196, null}
!198 = metadata !{i32 19, i32 0, metadata !199, null}
!199 = metadata !{i32 786443, metadata !67, metadata !69, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!200 = metadata !{i32 22, i32 0, metadata !201, null}
!201 = metadata !{i32 786443, metadata !67, metadata !199, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!202 = metadata !{i32 25, i32 0, metadata !203, null}
!203 = metadata !{i32 786443, metadata !67, metadata !201, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!204 = metadata !{i32 26, i32 0, metadata !205, null}
!205 = metadata !{i32 786443, metadata !67, metadata !203, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!206 = metadata !{i32 27, i32 0, metadata !205, null}
!207 = metadata !{i32 28, i32 0, metadata !208, null}
!208 = metadata !{i32 786443, metadata !67, metadata !203, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!209 = metadata !{i32 29, i32 0, metadata !208, null}
!210 = metadata !{i32 32, i32 0, metadata !201, null}
!211 = metadata !{i32 34, i32 0, metadata !69, null}
!212 = metadata !{i32 16, i32 0, metadata !81, null}
!213 = metadata !{i32 17, i32 0, metadata !81, null}
...
!219 = metadata !{i32 18, i32 0, metadata !81, null}
!220 = metadata !{i32 16, i32 0, metadata !221, null}
!221 = metadata !{i32 786443, metadata !96, metadata !98, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
!222 = metadata !{i32 19, i32 0, metadata !223, null}
!223 = metadata !{i32 786443, metadata !96, metadata !98, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
!224 = metadata !{i32 20, i32 0, metadata !225, null}
!225 = metadata !{i32 786443, metadata !96, metadata !223, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
...
!229 = metadata !{i32 786443, metadata !96, metadata !223, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
...
!234 = metadata !{i32 28, i32 0, metadata !98, null}
!235 = metadata !{i32 15, i32 0, metadata !112, null}
!236 = metadata !{i32 16, i32 0, metadata !112, null}
!237 = metadata !{metadata !237, metadata !215, metadata !216}
!238 = metadata !{metadata !238, metadata !215, metadata !216}
!239 = metadata !{i32 17, i32 0, metadata !112, null}
!240 = metadata !{i32 13, i32 0, metadata !126, null}
!241 = metadata !{i32 14, i32 0, metadata !126, null}
!242 = metadata !{i32 15, i32 0, metadata !126, null}
