...
; <label>:10                                      ; preds = %0
  ...
  store i32 %11, i32* %1, !dbg !141
  br label %12, !dbg !141

; <label>:12                                      ; preds = %10, %6
  %13 = load i32* %1, !dbg !142
  ret i32 %13, !dbg !142
}
...
define i64 @klee_choose(i64 %n) #3 {
  ...
  %1 = bitcast i64* %x to i8*, !dbg !143
  call void @klee_make_symbolic(i8* %1, i64 8, i8* getelementptr inbounds ([12 x i8]* @.str1, i64 0, i64 0)) #6, !dbg !143
  %2 = load i64* %x, align 8, !dbg !144, !tbaa !146
  %3 = icmp ult i64 %2, %n, !dbg !144
  br i1 %3, label %5, label %4, !dbg !144

; <label>:4                                       ; preds = %0
  call void @klee_silent_exit(i32 0) #7, !dbg !150
  unreachable, !dbg !150
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([60 x i8]* @.str12, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str123, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #7, !dbg !154
  unreachable, !dbg !154
...
define i32 @klee_int(i8* %name) #3 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #6, !dbg !156
...
define void @klee_overshift_check(i64 %bitWidth, i64 %shift) #3 {
  %1 = icmp ult i64 %shift, %bitWidth, !dbg !160
  br i1 %1, label %3, label %2, !dbg !160

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #7, !dbg !162
  unreachable, !dbg !162
...
define i32 @klee_range(i32 %start, i32 %end, i8* %name) #3 {
  %x = alloca i32, align 4
  %1 = icmp slt i32 %start, %end, !dbg !165
  br i1 %1, label %3, label %2, !dbg !165

; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([51 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #7, !dbg !167
  unreachable, !dbg !167

; <label>:3                                       ; preds = %0
  %4 = add nsw i32 %start, 1, !dbg !168
  %5 = icmp eq i32 %4, %end, !dbg !168
  br i1 %5, label %21, label %6, !dbg !168

; <label>:6                                       ; preds = %3
  %7 = bitcast i32* %x to i8*, !dbg !170
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #6, !dbg !170
  %8 = icmp eq i32 %start, 0, !dbg !172
  %9 = load i32* %x, align 4, !dbg !174, !tbaa !158
  br i1 %8, label %10, label %13, !dbg !172

; <label>:10                                      ; preds = %6
  %11 = icmp ult i32 %9, %end, !dbg !174
  %12 = zext i1 %11 to i64, !dbg !174
  call void @klee_assume(i64 %12) #6, !dbg !174
  br label %19, !dbg !176

; <label>:13                                      ; preds = %6
  %14 = icmp sge i32 %9, %start, !dbg !177
  %15 = zext i1 %14 to i64, !dbg !177
  call void @klee_assume(i64 %15) #6, !dbg !177
  %16 = load i32* %x, align 4, !dbg !179, !tbaa !158
  %17 = icmp slt i32 %16, %end, !dbg !179
  %18 = zext i1 %17 to i64, !dbg !179
  call void @klee_assume(i64 %18) #6, !dbg !179
  br label %19

; <label>:19                                      ; preds = %13, %10
  %20 = load i32* %x, align 4, !dbg !180, !tbaa !158
  br label %21, !dbg !180
...
define weak i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #3 {
  %1 = icmp eq i64 %len, 0, !dbg !182
  br i1 %1, label %._crit_edge, label %.lr.ph.preheader, !dbg !182
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !183
  %wide.load = load <16 x i8>* %3, align 1, !dbg !183
  %next.gep.sum279 = or i64 %index, 16, !dbg !183
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum279, !dbg !183
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !183
  %wide.load200 = load <16 x i8>* %5, align 1, !dbg !183
  %6 = bitcast i8* %next.gep103 to <16 x i8>*, !dbg !183
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !183
  %next.gep103.sum296 = or i64 %index, 16, !dbg !183
  %7 = getelementptr i8* %destaddr, i64 %next.gep103.sum296, !dbg !183
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !183
  store <16 x i8> %wide.load200, <16 x i8>* %8, align 1, !dbg !183
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !184
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !182
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !183
  %12 = load i8* %src.03, align 1, !dbg !183, !tbaa !187
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !183
  store i8 %12, i8* %dest.02, align 1, !dbg !183, !tbaa !187
  %14 = icmp eq i64 %10, 0, !dbg !182
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !182, !llvm.loop !188

._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %0
  ret i8* %destaddr, !dbg !189
}

; Function Attrs: nounwind uwtable
define weak i8* @memmove(i8* %dst, i8* %src, i64 %count) #3 {
  %1 = icmp eq i8* %src, %dst, !dbg !190
  br i1 %1, label %.loopexit, label %2, !dbg !190

; <label>:2                                       ; preds = %0
  %3 = icmp ugt i8* %src, %dst, !dbg !192
  br i1 %3, label %.preheader, label %18, !dbg !192

.preheader:                                       ; preds = %2
  %4 = icmp eq i64 %count, 0, !dbg !194
  br i1 %4, label %.loopexit, label %.lr.ph.preheader, !dbg !194
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %6 = bitcast i8* %next.gep to <16 x i8>*, !dbg !194
  %wide.load = load <16 x i8>* %6, align 1, !dbg !194
  %next.gep.sum586 = or i64 %index, 16, !dbg !194
  %7 = getelementptr i8* %src, i64 %next.gep.sum586, !dbg !194
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !194
  %wide.load207 = load <16 x i8>* %8, align 1, !dbg !194
  %9 = bitcast i8* %next.gep110 to <16 x i8>*, !dbg !194
  store <16 x i8> %wide.load, <16 x i8>* %9, align 1, !dbg !194
  %next.gep110.sum603 = or i64 %index, 16, !dbg !194
  %10 = getelementptr i8* %dst, i64 %next.gep110.sum603, !dbg !194
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !194
  store <16 x i8> %wide.load207, <16 x i8>* %11, align 1, !dbg !194
  %index.next = add i64 %index, 32
  %12 = icmp eq i64 %index.next, %n.vec
  br i1 %12, label %middle.block, label %vector.body, !llvm.loop !196
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %13 = add i64 %.02, -1, !dbg !194
  %14 = getelementptr inbounds i8* %b.04, i64 1, !dbg !194
  %15 = load i8* %b.04, align 1, !dbg !194, !tbaa !187
  %16 = getelementptr inbounds i8* %a.03, i64 1, !dbg !194
  store i8 %15, i8* %a.03, align 1, !dbg !194, !tbaa !187
  %17 = icmp eq i64 %13, 0, !dbg !194
  br i1 %17, label %.loopexit, label %.lr.ph, !dbg !194, !llvm.loop !197

; <label>:18                                      ; preds = %2
  %19 = add i64 %count, -1, !dbg !198
  %20 = icmp eq i64 %count, 0, !dbg !200
  br i1 %20, label %.loopexit, label %.lr.ph9, !dbg !200

.lr.ph9:                                          ; preds = %18
  %21 = getelementptr inbounds i8* %src, i64 %19, !dbg !201
  %22 = getelementptr inbounds i8* %dst, i64 %19, !dbg !198
...
vector.body209:                                   ; preds = %vector.body209, %vector.memcheck224
  ...
  %next.gep236.sum = add i64 %.sum440, -15, !dbg !200
  %24 = getelementptr i8* %src, i64 %next.gep236.sum, !dbg !200
  %25 = bitcast i8* %24 to <16 x i8>*, !dbg !200
  %wide.load434 = load <16 x i8>* %25, align 1, !dbg !200
  %reverse = shufflevector <16 x i8> %wide.load434, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !200
  %.sum505 = add i64 %.sum440, -31, !dbg !200
  %26 = getelementptr i8* %src, i64 %.sum505, !dbg !200
  %27 = bitcast i8* %26 to <16 x i8>*, !dbg !200
  %wide.load435 = load <16 x i8>* %27, align 1, !dbg !200
  %reverse436 = shufflevector <16 x i8> %wide.load435, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !200
  %reverse437 = shufflevector <16 x i8> %reverse, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !200
  %next.gep333.sum = add i64 %.sum472, -15, !dbg !200
  %28 = getelementptr i8* %dst, i64 %next.gep333.sum, !dbg !200
  %29 = bitcast i8* %28 to <16 x i8>*, !dbg !200
  store <16 x i8> %reverse437, <16 x i8>* %29, align 1, !dbg !200
  %reverse438 = shufflevector <16 x i8> %reverse436, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !200
  %.sum507 = add i64 %.sum472, -31, !dbg !200
  %30 = getelementptr i8* %dst, i64 %.sum507, !dbg !200
  %31 = bitcast i8* %30 to <16 x i8>*, !dbg !200
  store <16 x i8> %reverse438, <16 x i8>* %31, align 1, !dbg !200
  %index.next234 = add i64 %index212, 32
  %32 = icmp eq i64 %index.next234, %n.vec215
  br i1 %32, label %middle.block210, label %vector.body209, !llvm.loop !202
...
scalar.ph211:                                     ; preds = %scalar.ph211, %middle.block210
  ...
  %33 = add i64 %.16, -1, !dbg !200
  %34 = getelementptr inbounds i8* %b.18, i64 -1, !dbg !200
  %35 = load i8* %b.18, align 1, !dbg !200, !tbaa !187
  %36 = getelementptr inbounds i8* %a.17, i64 -1, !dbg !200
  store i8 %35, i8* %a.17, align 1, !dbg !200, !tbaa !187
  %37 = icmp eq i64 %33, 0, !dbg !200
  br i1 %37, label %.loopexit, label %scalar.ph211, !dbg !200, !llvm.loop !203
...
define weak i8* @mempcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #3 {
  %1 = icmp eq i64 %len, 0, !dbg !205
  br i1 %1, label %15, label %.lr.ph.preheader, !dbg !205
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !206
  %wide.load = load <16 x i8>* %3, align 1, !dbg !206
  %next.gep.sum280 = or i64 %index, 16, !dbg !206
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum280, !dbg !206
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !206
  %wide.load201 = load <16 x i8>* %5, align 1, !dbg !206
  %6 = bitcast i8* %next.gep104 to <16 x i8>*, !dbg !206
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !206
  %next.gep104.sum297 = or i64 %index, 16, !dbg !206
  %7 = getelementptr i8* %destaddr, i64 %next.gep104.sum297, !dbg !206
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !206
  store <16 x i8> %wide.load201, <16 x i8>* %8, align 1, !dbg !206
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !207
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !205
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !206
  %12 = load i8* %src.03, align 1, !dbg !206, !tbaa !187
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !206
  store i8 %12, i8* %dest.02, align 1, !dbg !206, !tbaa !187
  %14 = icmp eq i64 %10, 0, !dbg !205
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !205, !llvm.loop !208
...
; <label>:15                                      ; preds = %._crit_edge, %0
  ...
  ret i8* %dest.0.lcssa, !dbg !209
}

; Function Attrs: nounwind uwtable
define weak i8* @memset(i8* %dst, i32 %s, i64 %count) #3 {
  %1 = icmp eq i64 %count, 0, !dbg !210
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !210

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !211
  br label %3, !dbg !210

; <label>:3                                       ; preds = %3, %.lr.ph
  %a.02 = phi i8* [ %dst, %.lr.ph ], [ %5, %3 ]
  %.01 = phi i64 [ %count, %.lr.ph ], [ %4, %3 ]
  %4 = add i64 %.01, -1, !dbg !210
  %5 = getelementptr inbounds i8* %a.02, i64 1, !dbg !211
  store volatile i8 %2, i8* %a.02, align 1, !dbg !211, !tbaa !187
  %6 = icmp eq i64 %4, 0, !dbg !210
  br i1 %6, label %._crit_edge, label %3, !dbg !210
...
!12 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"f", metadata !"f", metadata !"", i32 14, metadata !13, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32, i32)* @f, null, null, metadata !2, i32 14} ; [ DW_TAG_subprogram 
...
!138 = metadata !{i32 16, i32 0, metadata !139, null}
!139 = metadata !{i32 786443, metadata !1, metadata !12, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/KLEEPlayground/ChallengeProblem/function.c]
!140 = metadata !{i32 17, i32 0, metadata !139, null}
!141 = metadata !{i32 19, i32 0, metadata !139, null}
!142 = metadata !{i32 20, i32 0, metadata !12, null}
!143 = metadata !{i32 14, i32 0, metadata !18, null}
!144 = metadata !{i32 17, i32 0, metadata !145, null}
!145 = metadata !{i32 786443, metadata !16, metadata !18, i32 17, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_choose.c]
!146 = metadata !{metadata !147, metadata !147, i64 0}
!147 = metadata !{metadata !"long", metadata !148, i64 0}
!148 = metadata !{metadata !"omnipotent char", metadata !149, i64 0}
!149 = metadata !{metadata !"Simple C/C++ TBAA"}
!150 = metadata !{i32 18, i32 0, metadata !145, null}
!151 = metadata !{i32 19, i32 0, metadata !18, null}
!152 = metadata !{i32 13, i32 0, metadata !153, null}
!153 = metadata !{i32 786443, metadata !28, metadata !30, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_div_zero_check.c]
!154 = metadata !{i32 14, i32 0, metadata !153, null}
!155 = metadata !{i32 15, i32 0, metadata !30, null}
!156 = metadata !{i32 15, i32 0, metadata !40, null}
!157 = metadata !{i32 16, i32 0, metadata !40, null}
!158 = metadata !{metadata !159, metadata !159, i64 0}
!159 = metadata !{metadata !"int", metadata !148, i64 0}
!160 = metadata !{i32 21, i32 0, metadata !161, null}
!161 = metadata !{i32 786443, metadata !50, metadata !52, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_overshift_check.c]
!162 = metadata !{i32 27, i32 0, metadata !163, null}
!163 = metadata !{i32 786443, metadata !50, metadata !161, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_overshift_check.c]
!164 = metadata !{i32 29, i32 0, metadata !52, null}
!165 = metadata !{i32 16, i32 0, metadata !166, null}
!166 = metadata !{i32 786443, metadata !61, metadata !63, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!167 = metadata !{i32 17, i32 0, metadata !166, null}
!168 = metadata !{i32 19, i32 0, metadata !169, null}
!169 = metadata !{i32 786443, metadata !61, metadata !63, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!170 = metadata !{i32 22, i32 0, metadata !171, null}
!171 = metadata !{i32 786443, metadata !61, metadata !169, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!172 = metadata !{i32 25, i32 0, metadata !173, null}
!173 = metadata !{i32 786443, metadata !61, metadata !171, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!174 = metadata !{i32 26, i32 0, metadata !175, null}
!175 = metadata !{i32 786443, metadata !61, metadata !173, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!176 = metadata !{i32 27, i32 0, metadata !175, null}
!177 = metadata !{i32 28, i32 0, metadata !178, null}
!178 = metadata !{i32 786443, metadata !61, metadata !173, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!179 = metadata !{i32 29, i32 0, metadata !178, null}
!180 = metadata !{i32 32, i32 0, metadata !171, null}
!181 = metadata !{i32 34, i32 0, metadata !63, null}
!182 = metadata !{i32 16, i32 0, metadata !75, null}
!183 = metadata !{i32 17, i32 0, metadata !75, null}
...
!187 = metadata !{metadata !148, metadata !148, i64 0}
!188 = metadata !{metadata !188, metadata !185, metadata !186}
!189 = metadata !{i32 18, i32 0, metadata !75, null}
!190 = metadata !{i32 16, i32 0, metadata !191, null}
!191 = metadata !{i32 786443, metadata !90, metadata !92, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
!192 = metadata !{i32 19, i32 0, metadata !193, null}
!193 = metadata !{i32 786443, metadata !90, metadata !92, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
!194 = metadata !{i32 20, i32 0, metadata !195, null}
!195 = metadata !{i32 786443, metadata !90, metadata !193, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
!196 = metadata !{metadata !196, metadata !185, metadata !186}
!197 = metadata !{metadata !197, metadata !185, metadata !186}
!198 = metadata !{i32 22, i32 0, metadata !199, null}
!199 = metadata !{i32 786443, metadata !90, metadata !193, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
!200 = metadata !{i32 24, i32 0, metadata !199, null}
!201 = metadata !{i32 23, i32 0, metadata !199, null}
!202 = metadata !{metadata !202, metadata !185, metadata !186}
!203 = metadata !{metadata !203, metadata !185, metadata !186}
!204 = metadata !{i32 28, i32 0, metadata !92, null}
!205 = metadata !{i32 15, i32 0, metadata !106, null}
!206 = metadata !{i32 16, i32 0, metadata !106, null}
!207 = metadata !{metadata !207, metadata !185, metadata !186}
!208 = metadata !{metadata !208, metadata !185, metadata !186}
!209 = metadata !{i32 17, i32 0, metadata !106, null}
!210 = metadata !{i32 13, i32 0, metadata !120, null}
!211 = metadata !{i32 14, i32 0, metadata !120, null}
!212 = metadata !{i32 15, i32 0, metadata !120, null}
