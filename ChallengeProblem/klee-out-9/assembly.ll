...
; <label>:10                                      ; preds = %0
  ...
  %12 = load i32* %4, align 4, !dbg !164
  %13 = add nsw i32 %11, %12, !dbg !164
  %int_cast_to_i64 = zext i32 2 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i64), !dbg !164
  %14 = sdiv i32 %13, 2, !dbg !164
  store i32 %14, i32* %mid, align 4, !dbg !164
  %15 = load i32* %5, align 4, !dbg !166
  %16 = load i32* %mid, align 4, !dbg !166
  %17 = sext i32 %16 to i64, !dbg !166
  %18 = load i32** %2, align 8, !dbg !166
  %19 = getelementptr inbounds i32* %18, i64 %17, !dbg !166
  %20 = load i32* %19, align 4, !dbg !166
  %21 = icmp slt i32 %15, %20, !dbg !166
  br i1 %21, label %22, label %29, !dbg !166

; <label>:22                                      ; preds = %10
  %23 = load i32** %2, align 8, !dbg !168
  %24 = load i32* %3, align 4, !dbg !168
  %25 = load i32* %mid, align 4, !dbg !168
  %26 = sub nsw i32 %25, 1, !dbg !168
  %27 = load i32* %5, align 4, !dbg !168
  %28 = call i32 @external_function(i32* %23, i32 %24, i32 %26, i32 %27), !dbg !168
  store i32 %28, i32* %1, !dbg !168
  br label %46, !dbg !168

; <label>:29                                      ; preds = %10
  %30 = load i32* %5, align 4, !dbg !169
  %31 = load i32* %mid, align 4, !dbg !169
  %32 = sext i32 %31 to i64, !dbg !169
  %33 = load i32** %2, align 8, !dbg !169
  %34 = getelementptr inbounds i32* %33, i64 %32, !dbg !169
  %35 = load i32* %34, align 4, !dbg !169
  %36 = icmp sgt i32 %30, %35, !dbg !169
  br i1 %36, label %37, label %44, !dbg !169

; <label>:37                                      ; preds = %29
  %38 = load i32** %2, align 8, !dbg !171
  %39 = load i32* %mid, align 4, !dbg !171
  %40 = add nsw i32 %39, 1, !dbg !171
  %41 = load i32* %4, align 4, !dbg !171
  %42 = load i32* %5, align 4, !dbg !171
  %43 = call i32 @external_function(i32* %38, i32 %40, i32 %41, i32 %42), !dbg !171
  store i32 %43, i32* %1, !dbg !171
  br label %46, !dbg !171

; <label>:44                                      ; preds = %29
  %45 = load i32* %mid, align 4, !dbg !172
  store i32 %45, i32* %1, !dbg !172
  br label %46, !dbg !172

; <label>:46                                      ; preds = %44, %37, %22, %9
  %47 = load i32* %1, !dbg !173
  ret i32 %47, !dbg !173
}
