...
define i32 @funky_math(i32 %input, i32 %param) #0 {
  ...
  store i32 0, i32* %result, align 4, !dbg !137
...
; <label>:3                                       ; preds = %9, %0
  ...
  %8 = load i32* %result, align 4, !dbg !140
  br i1 %7, label %9, label %17, !dbg !138

; <label>:9                                       ; preds = %3
  %10 = load i32* %1, align 4, !dbg !140
  %11 = add nsw i32 %8, %10, !dbg !140
  %12 = load i32* %i, align 4, !dbg !140
  %int_cast_to_i641 = zext i32 2 to i64
  call void @klee_overshift_check(i64 32, i64 %int_cast_to_i641), !dbg !140
  %13 = shl i32 %12, 2, !dbg !140
  %14 = add nsw i32 %11, %13, !dbg !140
  store i32 %14, i32* %result, align 4, !dbg !140
  %15 = load i32* %i, align 4, !dbg !138
  %16 = add nsw i32 %15, 1, !dbg !138
  store i32 %16, i32* %i, align 4, !dbg !138
  br label %3, !dbg !138

; <label>:17                                      ; preds = %3
  %18 = icmp eq i32 %8, 73, !dbg !141
  br i1 %18, label %19, label %21, !dbg !141

; <label>:19                                      ; preds = %17
  %20 = call i32 (i8*, i8*, i32, i8*, ...)* bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8]* @.str3, i32 0, i32 0), i32 18, i8* getel
  br label %21, !dbg !143

; <label>:21                                      ; preds = %19, %17
  %22 = load i32* %result, align 4, !dbg !144
  ret i32 %22, !dbg !144
}
