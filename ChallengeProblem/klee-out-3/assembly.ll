...
; <label>:23                                      ; preds = %20
  ...
  %25 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_asert to i32 (i32, ...)*)(i32 %24), !dbg !158
  %26 = load i32* %2, align 4, !dbg !159
  store i32 %26, i32* %1, !dbg !159
  br label %27, !dbg !159

; <label>:27                                      ; preds = %23, %22, %13, %6
  %28 = load i32* %1, !dbg !160
  ret i32 %28, !dbg !160
}

declare i32 @klee_asert(...) #2

; Function Attrs: nounwind uwtable
define i64 @klee_choose(i64 %n) #4 {
  %x = alloca i64, align 8
  %1 = bitcast i64* %x to i8*, !dbg !161
  call void @klee_make_symbolic(i8* %1, i64 8, i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0)) #7, !dbg !161
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([60 x i8]* @.str14, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str25, i64 0, i64 0)) #8, !dbg !172
  unreachable, !dbg !172
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str36, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str147, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str258, i64 0, i64 0)) #8, !dbg !180
  unreachable, !dbg !180
